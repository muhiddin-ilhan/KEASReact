...
export default class MapViewModalPolygon extends Component {
            ...
            <div>
                <Modal show={showDialog} onHide={dialogClose} size="lg">
                    <Modal.Header closeButton>
                        <Modal.Title>
                            <div className="ml-2">{"Bölge Konumu"}</div>
                        </Modal.Title>
                    </Modal.Header>
                    <Modal.Body>
                        <div>
                            <MapContainer style={{ height: 400, width: '100%' }} center={[39.90, 32.85]} zoom={9} scrollWheelZoom={true}
                                ...
                                {
                                    info.length &&
                                    <Polygon pathOptions={{ color: 'purple', fillColor: 'blue' }} positions={info} />
                                }
