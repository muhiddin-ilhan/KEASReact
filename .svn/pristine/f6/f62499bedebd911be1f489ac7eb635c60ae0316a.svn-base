...
export default class VendorAddView extends Component {
    constructor(props) {
        super(props);
    ...
    onInsertVendor = async () => {
        ...
        if (this.validateInputs()) {
            ...
            const response = await HttpRequest(body, "/Vendor/InsertVendor");
    ...
    render() {
        ...
        return (
            <div>
                <Header />
                <Menu pageName={PageConstant.VENDOR_ADD_PAGE_URL} />
                <div className="content-wrapper">
                    <PageContentHeader>
                        <h1 className="m-0 text-dark">Tedarikçi Ekle</h1>
                    </PageContentHeader>
                            ...
                            <div className="card-body">
                                ...
                                <div className="form-group row">
                                    <div className="col-sm-12 mt-3">
                                        <button disabled={isLoading} onClick={this.onInsertVendor} class="btn btn-block btn-outline-success">
                                            {isLoading ? (
